...
const checkAge = function(age) {
    if (age < age_2) {
        console.log("You are " + age + " years old. You don’t have access cause your age is less then.")
    }
    else if  (age >= age_2 && age <= age_3) {
        console.log("You are " + age + " years old. Welcome!")
    }
    else if (age > age_3) {
    console.log("You are " + age + " years old. Keep calm and look Culture channel.")
    }
} 
   checkAge(17)
...
} else {console.log("ERROR! Wrong data type! Enter a number!")}
} 
checkAge1(18)
